...
<<comment
packages installed:
 buildah	1:1.27.2-2.el9_1
 cockpit-podman	53-1.el9
 podman-docker	2:4.2.0-7.el9_1
 podman-remote	2:4.2.0-7.el9_1
 python3-podman	3:4.2.1-1.el9_1
 python3-pyxdg	0.27-3.el9
 python3-toml	0.10.2-6.el9
 runc	4:1.1.4-1.el9_1
 skopeo	2:1.9.4-0.1.el9_1
 toolbox	0.0.99.3-5.el9
 udica	0.2.6-4.el9
